...
baundrate 921600
Onboard-SDK-ROS/dji_sdk/src/modules/dji_sdk_node.cpp

L92 disable advanced_sensing
L128 disable ACM pathinit
L527 rtkSupport = false; //disble RTK support

    ROS_INFO("altittude:%f",current_atti);

  else if (request.task == 13)
  {
    // exittakeoff
    ack = vehicle->control->action(Control::FlightCommand::exitTakeOff,WAIT_TIMEOUT);
    ROS_DEBUG("called vehicle->control->exittakeoff()");
  }
