 ...
 * seperated into two files, SimVideoStream_Class and SimVideoStream_Node. Improve the image transfer stability
 */
...
{
  subHandler_video_right = nodeHandler.subscribe("/yigle/camera/right/image_raw", 1, &VideoStream::getVideoCallback_right, this);
  subHandler_video_left = nodeHandler.subscribe("/yigle/camera/left/image_raw", 1, &VideoStream::getVideoCallback_left, this);
